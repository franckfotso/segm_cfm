...
def vis_seg(img_names, cls_names, output_dir, gt_dir, cfg):
    """
...
def _convert_pred_to_image(img_width, img_height, pred_dict, cfg):
    ...
    for i in xrange(num_inst):
        ...
        mask = mask >= cfg.MAIN_DEFAULT_BINARIZE_THRESH
