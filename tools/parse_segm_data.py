...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# usage: python tools/parse_segm_data.py --dataset voc_2007 \
...
def parse_args():
    ...
    ap.add_argument('--in_pr_dir', dest='in_pr_dir',
                        help='input directory of raw proposals',
                        default='data/voc_2007/MCG-RAW', type=str)
    ap.add_argument('--in_pr_meth', dest='in_pr_meth',
                        help='proposal method rel. to raw',
...
def parse_from_mcg(l_start, l_end, dataset, gt_set,
                          max_pr, in_pr_dir, out_seg_dir, ):                          
    im_names = dataset.sets[gt_set]["im_names"]
    timer = Timer()
    ...
    for proc_id in xrange(num_proc):
        ...
        if args["dataset"] in ['voc_2007', 'voc_2012', 'voc_2007_2012']:
            if args['type'] == 'gt':
                ...
                raise Exception('[ERROR] unknow type of process to execute: {}'\
                                .format(args['type']))
            ...
            elif args['type'] == 'pr' and args['in_pr_meth'] == 'mcg':
                in_pr_dir = args['in_pr_dir']
                p = Process(target=parse_from_mcg, 
                            args=(l_start, l_end, dataset, gt_set,
                                  max_pr, in_pr_dir, out_seg_dir))
                                  
            elif args['type'] == 'pr' and args['in_pr_meth'] == 'cob':
